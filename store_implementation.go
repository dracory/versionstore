...
func (store *storeImplementation) logSql(sqlStr string, sqlParams ...interface{}) {
...
func (store *storeImplementation) versionQuery(options VersionQueryInterface) (selectDataset *goqu.SelectDataset, columns []any, err error) {
	if options == nil {
